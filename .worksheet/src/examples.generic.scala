...
object generic {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(186); 
  ...
  val conn: Connection = new Connection();System.out.println("""conn  : examples.generic.Connection = """ + $show(conn ));$skip(115); 
  val msg = withClose(conn) { conn =>
    {
      println("do something with Connection")
      "123456"
    }
  };System.out.println("""msg  : String = """ + $show(msg ));$skip(16); 
